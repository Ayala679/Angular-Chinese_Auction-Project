...
// import { DialogService, DynamicDialogModule, DynamicDialogRef } from 'primeng/dynamicdialog'; // ייבוא השירות
// @Component({
//   selector: 'app-get-all-categories',
//   standalone: true,
//   imports: [ButtonModule, CardModule, AsyncPipe, DynamicDialogModule],
...
//         const obj = { name: result.name, picture: result.picture.name ,file:result.file};
